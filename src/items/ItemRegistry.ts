...
export const BLOCK_SWATCH_COLORS: Record<number, string> = {
  ...
  [BlockId.DOOR_N_CLOSED]: '#7A5230',
  [BlockId.DOOR_N_OPEN]:   '#7A5230',
  [BlockId.DOOR_E_CLOSED]: '#7A5230',
  [BlockId.DOOR_E_OPEN]:   '#7A5230',
  [BlockId.DOOR_S_CLOSED]: '#7A5230',
  [BlockId.DOOR_S_OPEN]:   '#7A5230',
  [BlockId.DOOR_W_CLOSED]: '#7A5230',
  [BlockId.DOOR_W_OPEN]:   '#7A5230',
  [BlockId.TORCH]:         '#FFA020',
  [BlockId.GLOWSTONE]:   '#C99A2E',
  [BlockId.BED]:         '#A93B36',
  [BlockId.LAVA]:        '#D8401A',
  [BlockId.CACTUS]:      '#3C7D32',
  [BlockId.SANDSTONE]:   '#D9CB94',
  [BlockId.TALL_GRASS]:    '#5DAD3A',
  [BlockId.FLOWER_RED]:    '#D9402F',
  [BlockId.FLOWER_YELLOW]: '#F2C84B',
};

// === Block item identity set — built once at module load ===
const _blockIdSet = new Set<number>(Object.values(BlockId));

/** True if id is one of the BlockId numeric values (0..38). */
...
export const ITEM_DEFS: Map<ItemId, ItemDef> = new Map([
  ...
  [ItemId.RAW_BEEF, {
    ...
    armor: null,
    food: { hungerRestore: 3, saturationRestore: 1.8 } satisfies FoodDef,
  }],
  [ItemId.RAW_PORKCHOP, {
  ...
  [ItemId.RAW_CHICKEN, {
    ...
    armor: null,
    food: { hungerRestore: 2, saturationRestore: 1.2 } satisfies FoodDef,
  }],
  [ItemId.RAW_MUTTON, {
  ...
  [ItemId.COOKED_BEEF, {
    ...
    armor: null,
    food: { hungerRestore: 8, saturationRestore: 12.8 } satisfies FoodDef,
  }],
  ...
  [ItemId.COOKED_CHICKEN, {
    ...
    armor: null,
    food: { hungerRestore: 6, saturationRestore: 7.2 } satisfies FoodDef,
  }],
  [ItemId.COOKED_MUTTON, {
    ...
    armor: null,
    food: { hungerRestore: 6, saturationRestore: 9.6 } satisfies FoodDef,
  }],
  [ItemId.DOOR, {
