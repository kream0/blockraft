...
import { PlayerState, BlockId, GameMode, PLAYER_EYE, PLAYER_MAX_HEALTH, PLAYER_MAX_HUNGER, PLAYER_DEFAULT_SATURATION, ARMOR_SLOT_COUNT, type ItemId } from '../types';
...
export class Player {
  ...
  constructor(spawnX: number, spawnY: number, spawnZ: number, fov: number = 75, gameMode: GameMode = GameMode.SURVIVAL) {
    this.state = {
      ...
      saturation: PLAYER_DEFAULT_SATURATION,
