...
- **Iron armor** (Survival): craft a **helmet, chestplate, leggings, and boots** from iron ingots, then **right-click** a piece to wear it in its body slot (any piece already worn there swaps back to your hotbar). Worn armor shows as a shield meter above the hearts and **soaks up a share of incoming combat and fall damage** (more pieces = more protection, up to a cap) while leaving starvation and drowning at full bite; it persists per-world through save/load and stays on through death and respawn
...
- **A wider recipe book**: more crafting + smelting recipes and **further armor tiers** — the crafting grid, **wooden / stone / iron tools and swords**, **iron armor** (helmet / chestplate / leggings / boots), and **smelting via the furnace** (ore→ingot, sand→glass, cobble→stone, raw→cooked food) already ship (see Items & inventory above)
